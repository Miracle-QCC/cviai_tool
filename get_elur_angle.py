...
class PoseEstimator:
    ...
    def __init__(self, img_size=(480, 640)):
        ...
        self.model_points_5 = np.array([
            ...
            (165.0,-170,-135.0),  # Left eye left corner
...
def run():
    ...
    points_5 = np.array(([25.0,122.0],
                         [31.0,121.0],
                         [12.0,148.0],
                         [34.0,168.0],
                         [36.0,167.0 ]))
    img = cv2.imread(r'D:\Code\scrfd\outputs\00000004.jpg')
    pose_estimator = PoseEstimator(img_size=img.shape)
    pose = pose_estimator.solve_pose_by_5_points(points_5)
    # pose = pose_estimator.solve_pose_by_6_points(points_6)
    ...
    line = 'Y:{:.1f}\nX:{:.1f}\nZ:{:.1f}'.format(Y, X, Z)
    print('{},{}'.format(os.path.basename('../coco_train/000000000036.jpg'), line.replace('\n', ',')))
    print(1 - 0.4 * X / 90 - 0.3 * Y / 90 - 0.3*Z / 90)
    y = 20
